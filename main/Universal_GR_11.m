...
%     nogotrialstoplot=[];
    ...
    for k=1:length(blocks.nogotrialnames{i})
     ...
     [w_setpoint_trials,w_setpoint_early,w_setpoint_late,w_setpoint_trials_med,w_setpoint_trials_medbinned,w_setpoint_trials_width,w_setpoint_trials_dur,w_setpoint_trials_prewhisk,w_setpoint_trials_prewhiskbinned,pvalsetpoint,...
         w_amp_trials,w_amp_early,w_amp_late,w_amp_trials_med,w_amp_trials_medbinned,w_amp_trials_width,pvalamp]= wdatasummary(wSigTrials,blocks.tag,blocks.nogotrialnums,avg_trials,gopix,nogopix,restrictTime,p,plot_whiskerfits,'nogo',timewindowtag);
     for i=1:numblocks
         ...
         blocks.nogo_setpoint_trials_medbinned{i} = w_setpoint_trials_medbinned{i};
         ...
         blocks.nogo_setpoint_trials_prewhiskbinned{i} =w_setpoint_trials_prewhiskbinned{i};
         ...
         blocks.nogo_amp_trials_medbinned{i} = w_amp_trials_medbinned{i};
...
%          blocks.nogo_amp_trials_hist{i} =w_amp_trials_hist{i};
     ...
     [w_setpoint_trials,w_setpoint_early,w_setpoint_late,w_setpoint_trials_med,w_setpoint_trials_medbinned,w_setpoint_trials_width,w_setpoint_trials_dur,w_setpoint_trials_prewhisk,w_setpoint_trials_prewhiskbinned,pvalsetpoint,...
         w_amp_trials,w_amp_early,w_amp_late,w_amp_trials_med,w_amp_trials_medbinned,w_amp_trials_width,pvalamp]= wdatasummary(wSigTrials,blocks.tag,blocks.gotrialnums,avg_trials,gopix,nogopix,restrictTime,p,plot_whiskerfits,'go',timewindowtag);
     for i=1:numblocks
...
% % %        wSigSum_Sessions.setpoint{i,j}=[data;lower;upper;xval']';
       ...
       wSigSum_Sessions.setpointbinned{i,j} = [binnedxdata;binnedydata]';
       axes(ah2);
